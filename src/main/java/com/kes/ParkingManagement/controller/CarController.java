...
//        model.addAttribute("car", dto);
        ...
        // carNumber를 URL에 추가하여 redirect
        UriComponentsBuilder builder = UriComponentsBuilder.fromUriString("/car/checkout")
    ...
    */
    @GetMapping("/checkout")
    public String checkout(@RequestParam("carNumber") String carNumber, Model model, RedirectAttributes redirectAttributes){
        Boolean carState = carService.outCheck(carNumber);
